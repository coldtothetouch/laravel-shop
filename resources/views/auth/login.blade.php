...
@section('content')
    <x-forms.form action="" method="POST">
        ...
        <x-forms.primary-button :value="'Войти'"/>
        ...
        <x-slot:buttons>
            <div class="space-y-3 mt-5">
                <div class="text-xxs md:text-xs"><a href="{{ route('auth.forgot-password.index') }}"
                                                    class="text-white hover:text-white/70 font-bold">Забыли пароль?</a>
                </div>
                <div class="text-xxs md:text-xs"><a href="{{ route('auth.register.index') }}"
